...
4. 2つ目のポータルの枠を作成し、木の斧で枠を指定して  
   ...
   /mvp create [ポータル名2] p:[ポータル名1]:[方角]で移動先の向きを指定できる。  
   [方角] n:北、s:南、e:東、w:西  
...
6. /mvp modify dest p:[ポータル名2]:[方角]で移動先の向きを指定できる。  
...
村判定の範囲仕様を示す。なお、ここではJAVA版の話でまとめる。  
  

結論。村の中心は村人と紐づかれたベッドや職業ブロックが中心となる。  
明確な固定数値ではなく、村人が紐づいているベッドや職業ブロックの場所までが村と認識される。
目安として、ベッドやブロックがある箇所から、最大で約96ブロック離れた場所までが村の範囲として計算されることが多い。なお、村人は水平方向に約48ブロック程度離れたベッドや職業ブロックを検出し、紐づくことが可能。  
また、2つの村の中心が128ブロック以内に重なると1つの村に結合される。よって、独立した村として扱うには、ベッドや職業ブロックを129ブロック以上離して設置する必要がある。  
  
ゴーレムは、召喚する村人から16x13x16の範囲に召喚される。  
...
村の中心は最初に村人と紐づかれたベッドや職業ブロックが中心となる。  
なお、統合版と異なり、固定される。  
ただし、村の統合により、統合先の村の範囲分、村の範囲が拡張されることを留意すること。  
  


### 村の実際の範囲(JAVA版)

　　　　　　　　　　　　　　　　　　　　村の中心（最初に村人と紐づいたベッドや職業ブロック）  
◆----------◆------------------□------------------◆----------◆  
　128マス　　49マス以上　48マス　　48マス　49マス以上　　　　　128マス  
  
この範囲内にさらにベッドや職業ブロックを置くと、その分、村の範囲が広がってしまう。  
