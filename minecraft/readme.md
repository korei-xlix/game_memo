...
このドキュメントは、minecraftの攻略状況や村の座標メモです。  
...
* minecraftメモ類
  * [minecraftコマンドメモ](./manual/command.md)
  * [minecraftサーバ(Java版テンプレート)](./my_server/template/server_template.md)
  * [minecraftサーバ(統合版テンプレート)](./my_server/template/server_template_realms.md)
